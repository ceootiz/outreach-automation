...
MAIN_LAUNCHER="${LAUNCHERS_DIR}/Gmail Рассылка.command"
ALT_LAUNCHER="${LAUNCHERS_DIR}/Gmail Рассылка Launcher.command"
...
chmod +x "${MAIN_LAUNCHER}" "${ALT_LAUNCHER}"

echo "Launcher created:"
echo "  ${MAIN_LAUNCHER}"
echo "  ${ALT_LAUNCHER}"
echo
echo "Double-click 'Gmail Рассылка.command' in Finder to start the app."
echo "Use OUTREACH_AUTOMATION_LAUNCH_MODE=dev for dev mode or production for packaged app only."
